...
class IntraNullPtrTransFunc {
	
	private static IntraNullPtrTransFunc instance = null;
	
	public static IntraNullPtrTransFunc getInstance() {
		if (instance == null)
			instance = new IntraNullPtrTransFunc();
		return instance;
	}
...
/*					//for debugging
    ...
    private void processNullAssign(Unit u, Disjunction IN, Disjunction OUT) {
    	//need to consider dropping false constraint here
    	updateEnv(u, IN, OUT);
    }
	...
	public void init(UnitGraph cfg, DataflowFactMapping env) {
